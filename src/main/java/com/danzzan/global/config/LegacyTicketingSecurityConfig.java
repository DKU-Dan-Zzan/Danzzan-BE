...
import com.danzzan.global.jwt.JwtAuthenticationFilter;
...
@ConditionalOnProperty(name = "legacy.ticketing.security.enabled", havingValue = "true")
@RequiredArgsConstructor
public class LegacyTicketingSecurityConfig {
