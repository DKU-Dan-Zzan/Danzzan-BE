...
import com.danzzan.domain.ticket.exception.*;
...
@ConditionalOnProperty(name = "legacy.ticketing.exception-handler.enabled", havingValue = "true")
public class LegacyTicketingGlobalExceptionHandler {
